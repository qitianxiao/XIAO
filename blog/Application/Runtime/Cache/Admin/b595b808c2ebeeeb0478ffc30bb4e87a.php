    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            ...
            <ul class="ht-nav">
                ...
                <li class="ht-nav-item">
                    <a href="<?php echo U('Login/login');?>"><i class="fa fa-power-off fa-fw"></i>注销</a>
                </li>
            </ul>
        </div>
        <!--侧边导航-->
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="<?php echo U('Article/show');?>" data-id="1">博文管理</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Category/show');?>" data-id="2">分类管理</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Label/show');?>" data-id="3">标签管理</a></dd>
                            
                            <dd><a href="javascript:;" data-url="<?php echo U('Admin/show');?>" data-id="4">管理员管理</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Log/show');?>">管理员日志管理</a></dd>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd><a href="javascript:;" data-url="<?php echo U('Config/show');?>" data-id="5">网站管理</a></dd>
                ...
                <div class="layui-field-box">
                    <div style="width:832px;margin:0 auto;">
                        <div class="windows-tile windows-two">
                            ...
                            <span data-url="" data-id="1">文章管理</span>
                        </div>
