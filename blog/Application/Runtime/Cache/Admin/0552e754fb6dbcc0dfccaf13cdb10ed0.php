            ...
            <div id="articleIndexTop">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item" style="margin:0;margin-top:15px;">
                            ...
                            <div class="layui-input-inline">
                                <select name="city">
                                    <option value="0"></option>
                                      <?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v['category_id']); ?>"><?php echo ($v['category_name']); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width:auto">
                                <a id="addArticle" class="layui-btn layui-btn-normal" href="<?php echo U('Category/add');?>">分类添加</a>
                            </div>
                        </div>
                    </div>
                </form>
