...
layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    form.on('submit(login)', function (data) {
        ...
        setTimeout(function () {
            ...
            // } else {
                ...
                layer.closeAll('page');
                setTimeout(function () {
                    location.href = "http://www.blog.com/index.php/Admin/Login/checklogin?admin_name="+data.field.account+"&admin_pwd="+data.field.password;
                }, 1000);
            // }
    ...
    function login() {
        ...
        loginHtml += '<input type="text" name="account" lay-verify="account" placeholder="请输入账号" value="xiao" autocomplete="off" class="layui-input">';
        loginHtml += '</div>';
        loginHtml += '</div>';
        loginHtml += '<div class="layui-form-item">';
