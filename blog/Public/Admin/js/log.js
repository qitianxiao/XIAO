...
layui.define(['laypage', 'layer', 'form', 'pagesize'], function (exports) {
    ...
    function initilData(currentIndex=1, pageSize=10) {
        ...
        setTimeout(function () {
            ...
            html += '<thead><tr><th>操作日志时间</th><th>管理员</th><th>操作内容</th><th>管理员ip</th><th colspan="2">选项</th><th colspan="2">操作</th></tr></thead>';
            html += '<tbody>';
            //遍历文章集合
